...
function makeName(roleLetter, number) {
    ...
    while (usedName == -3 && x <= number) {
        console.log(number);
        if (x > 4 || roleLetter[0] == 'A') {
            switch(roleLetter[0]) {
                case 'H':
                    role = [['H'],['harvester'],[WORK,WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,MOVE,MOVE,MOVE]];
                    break;
                case 'U':
                    role = [['U'],['upgrader'],[WORK,WORK,WORK,CARRY,CARRY,CARRY,MOVE,MOVE]];
                    break;
                case 'T':
                    role = [['T'],['transporter'],[WORK,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE]];
                    break;
                case 'B':
                    role = [['B'],['builder'],[WORK,WORK,WORK,CARRY,CARRY,MOVE,MOVE,MOVE]];
                    break;
                case 'A':
                    ...
                    role = [['A'],['attacker'],[TOUGH,TOUGH,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,ATTACK,ATTACK,ATTACK,ATTACK,ATTACK,ATTACK,ATTACK]];
        
                    break;
                case 'S':
                    role = [['S'],['scout'],[CLAIM,MOVE,MOVE]];
                    break;
            }
        } else  if (x > 2){
            switch(roleLetter[0]) {
